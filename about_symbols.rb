...
class AboutSymbols < Neo::Koan
  ...
  # Bellow i changed RubyConstant --> RubyConstants to test.

  in_ruby_version("mri") do
    RubyConstants = "What is the sound of one hand clapping?"
    def test_constants_become_symbols
      all_symbols_as_strings = Symbol.all_symbols.map { |x| x.to_s }

      assert_equal true, all_symbols_as_strings.include?("RubyConstants")
    end
  end
